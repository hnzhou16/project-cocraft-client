...
const UserProfile: React.FC<UserProfileProps> = ({userId}) => {
  ...
  const {userPostsFeed} = useAppSelector((state: any) => state.post);
  const {loading, error} = userPostsFeed;
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <div className="p-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-start">
            {/* User Avatar */}
            <div
              className="w-24 h-24 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center text-gray-700 dark:text-gray-300 text-4xl font-bold mb-4 sm:mb-0 sm:mr-6">
