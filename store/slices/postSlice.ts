...
import {Post, CreatePostPayload, UpdatePostPayload, PaginationQuery} from '@/types';
...
export const updatePost = createAsyncThunk<Post, {postId: string, postData: UpdatePostPayload}, {rejectValue: string}>(
  'post/updatePost',
...
export const getPost = createAsyncThunk<Post, string, {rejectValue: string}>(
  'post/getPost',
  async (postId: string, {rejectWithValue}) => {
    try {
...
export const likePost = createAsyncThunk<string, string, {rejectValue: string}>(
  'post/likePost',
  async (postId: string, {rejectWithValue}) => {
    try {
...
export const unlikePost = createAsyncThunk<string, string, {rejectValue: string}>(
  'post/unlikePost',
  async (postId: string, {rejectWithValue}) => {
    try {
...
export const fetchUserPosts = createAsyncThunk<Post[], {userId: string, pagination: PaginationQuery}, {rejectValue: string}>(
  'post/fetchUserPosts',
  async ({userId, pagination}: { userId: string; pagination?: PaginationQuery }, {rejectWithValue}) => {
    try {
      const response = await postService.getUserPosts(userId, pagination);
      return response;
    } catch (error: any) {
